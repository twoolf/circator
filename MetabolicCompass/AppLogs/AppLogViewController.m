...
+ (void)showAppLog{
    ...
    if ([curPresentedNC.viewControllers.firstObject isKindOfClass:[AppLogViewController class]]){
        ...
        AppLogViewController * appLogVC = [[UIStoryboard storyboardWithName:@"AppLog" bundle:[AppLogViewController bundle]] instantiateInitialViewController];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AppLogDetailViewController * logDetailVC = [[UIStoryboard storyboardWithName:@"AppLog" bundle:[AppLogViewController bundle]] instantiateViewControllerWithIdentifier:@"AppLogDetailViewController"];
