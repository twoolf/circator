...
public class ScaleFontTextField: UITextField {
    ...
    override public var font: UIFont!{
        ...
        set {
            ...
            if newValue != nil{
                let scaledFont = newValue!.fontWithSize(newValue!.pointSize * ScaleFontTextField.scaleFactor)
