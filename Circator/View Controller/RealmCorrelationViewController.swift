//
//  RealmCorrelationViewController.swift
//  Circator
//
...
class RealmCorrelationViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
