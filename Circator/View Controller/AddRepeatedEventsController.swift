//
//  AddRepeatedEventsController.swift
//  Circator
//
...
class AddRepeatedEventsController: UITableViewController, UITextFieldDelegate {
    ...
    func selectEvent(sender: UIBarButtonItem) {
//        let event = Weekdays.
        dismissPopup(sender)
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
                ...
                cell.accessoryView = {
                    ...
                    textField.inputAccessoryView = {
                        ...
                        view.items = [
                            ...
                            UIBarButtonItem(barButtonSystemItem: .Done, target: self, action: "selectEvent:")
                        ]
                        return view
                    }()
            ...
            case 2:
                ...
                cell.detailTextLabel?.text = selectedDays.description
                return cell
            case 3:
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if indexPath.section == 0 {
            ...
            case 2:
                ...
                daySelectionVC.selectedIndices = selectedDays.indexSet
                daySelectionVC.selectionUpdateHandler = { [unowned self] days in
                    self.selectedDays = Weekdays(indices: days)
