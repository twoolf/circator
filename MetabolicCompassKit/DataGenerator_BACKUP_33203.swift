...
=======
    private func generateDataset(path: String, users: [String], startDate: NSDate, endDate: NSDate) {
...
=======
        generateDataset(path, users:users, startDate:startDateDay, EndDate:endDate)
>>>>>>> Stashed changes
    }
...
=======
    ...
    public func generateDatasetForUser(path: String, userId: String, size: Int, startDate: NSDate, endDate: NSDate) {
        generateDataset(path, users: [userId], startDate: startDate, days: days)
>>>>>>> Stashed changes
    }
